...
int main()
{
  ...
  TH2F *Qkn_IMnpipi = new TH2F( "Qkn_IMnpipi", "Qkn_IMnpipi", PISIGMA_BIN, PISIGMA_MIN, PISIGMA_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  TH2F *Cosp_IMnpipi = new TH2F( "Cosp_IMnpipi", "Cosp_IMnpipi", PISIGMA_BIN, PISIGMA_MIN, PISIGMA_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  TH2F *CosX_IMnpipi = new TH2F( "CosX_IMnpipi", "CosX_IMnpipi", PISIGMA_BIN, PISIGMA_MIN, PISIGMA_MAX, QKN_BIN, QKN_MIN, QKN_MAX );

  TH2F *Qkn_IMnppipi = new TH2F( "Qkn_IMnppipi", "Qkn_IMnppipi", PISIGMAP_BIN, PISIGMAP_MIN, PISIGMAP_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  ...
  TH2F *Qkn_IMnpipi_acc = new TH2F( "Qkn_IMnpipi_acc", "Qkn_IMnpipi_acc", PISIGMA_BIN, PISIGMA_MIN, PISIGMA_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  TH2F *Qkn_IMnppipi_acc = new TH2F( "Qkn_IMnppipi_acc", "Qkn_IMnppipi_acc", PISIGMAP_BIN, PISIGMAP_MIN, PISIGMAP_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  ...
  TH2F *Qkn_IMnpipi_Sp = new TH2F( "Qkn_IMnpipi_Sp", "Qkn_IMnpipi_Sp", PISIGMA_BIN, PISIGMA_MIN, PISIGMA_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  TH2F *Qkn_IMnpipi_Sm = new TH2F( "Qkn_IMnpipi_Sm", "Qkn_IMnpipi_Sm", PISIGMA_BIN, PISIGMA_MIN, PISIGMA_MAX, QKN_BIN, QKN_MIN, QKN_MAX );

  TH2F *Qkn_IMnppipi_Sp = new TH2F( "Qkn_IMnppipi_Sp", "Qkn_IMnppipi_Sp", PISIGMAP_BIN, PISIGMAP_MIN, PISIGMAP_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  TH2F *Qkn_IMnppipi_Sm = new TH2F( "Qkn_IMnppipi_Sm", "Qkn_IMnppipi_Sm", PISIGMAP_BIN, PISIGMAP_MIN, PISIGMAP_MAX, QKN_BIN, QKN_MIN, QKN_MAX );
  ...
  for (Int_t i=0; i<nevent; i++) {
    ...
    Qkn_IMnpipi->Fill(mom_piS.M()/1000, qkn.P()/1000.0);
    ...
    Qkn_IMnppipi->Fill(mom_piSp.M()/1000, qkn.P()/1000.0);

    if( reactionData->ReactionID()==2120 ){ // 2120: K- 3He -> S+ p n p-
      Qkn_IMnpipi_Sp->Fill(mom_piS.M()/1000, qkn.P()/1000.0);
      Qkn_IMnppipi_Sp->Fill(mom_piSp.M()/1000, qkn.P()/1000.0);
    }
    else if( reactionData->ReactionID()==2130 ){ // 130: K- 3He -> S- p n p+
      Qkn_IMnpipi_Sm->Fill(mom_piS.M()/1000, qkn.P()/1000.0);
      Qkn_IMnppipi_Sm->Fill(mom_piSp.M()/1000, qkn.P()/1000.0);
    }
    ...
    if( nCDH[1]*nCDH[2]*nCDH[3]*nCDH[4] ){
      ...
      Qkn_IMnpipi_acc->Fill(mom_piS.M()/1000, qkn.P()/1000.0);
      Qkn_IMnppipi_acc->Fill(mom_piSp.M()/1000, qkn.P()/1000.0);
      //IMnpipi_IMnppipi->Fill(mom_piSp.M()/1000, mom_piS.M()/1000);
    }
  ...
  gPad->SetLogz();
  Qkn_IMnpipi->Draw("colz");
  Qkn_IMnpipi->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  Qkn_IMnpipi->SetYTitle("q_{Kn} [GeV/c]");
  Qkn_IMnpipi->SetStats(0);
  line = new TLine(Kp_mass, QKN_MIN, Kp_mass, QKN_MAX);
  line->SetLineColor(1);
  line->SetLineStyle(2);
  line->Draw();
  line = new TLine(piS_mass1, QKN_MIN, piS_mass1, QKN_MAX);
  line->SetLineColor(1);
  line->SetLineStyle(2);
  line->Draw();
  line = new TLine(piS_mass2, QKN_MIN, piS_mass2, QKN_MAX);
  line->SetLineColor(1);
  line->SetLineStyle(2);
  line->Draw();
  c1->Print("tmp.pdf(");
  ...
  gPad->SetLogz();
  Qkn_IMnpipi_acc->Draw("colz");
  Qkn_IMnpipi_acc->SetXTitle("IM(n#pi^{+}#pi^{-}) [GeV/c^{2}]");
  Qkn_IMnpipi_acc->SetYTitle("q_{Kn} [GeV/c]");
  Qkn_IMnpipi_acc->SetStats(0);
  line = new TLine(Kp_mass, QKN_MIN, Kp_mass, QKN_MAX);
  line->SetLineColor(1);
  line->SetLineStyle(2);
  line->Draw();
  ...
  his = (TH1F*)Qkn_IMnpipi_acc->ProjectionX();
  ...
  gPad->SetLogz();
  Qkn_IMnppipi_acc->Draw("colz");
  //Qkn_IMnppipi_acc->Draw("cont2");
  Qkn_IMnppipi_acc->SetXTitle("IM(np#pi^{+}#pi^{-}) [GeV/c^{2}]");
  Qkn_IMnppipi_acc->SetYTitle("q_{Kn} [GeV/c]");
  Qkn_IMnppipi_acc->SetStats(0);
  line = new TLine(Kpp_mass, QKN_MIN, Kpp_mass, QKN_MAX);
  line->SetLineColor(1);
  line->SetLineStyle(2);
  line->Draw();
  line = new TLine(piSp_mass1, QKN_MIN, piSp_mass1, QKN_MAX);
  line->SetLineColor(1);
  line->SetLineStyle(2);
  line->Draw();
  line = new TLine(piSp_mass2, QKN_MIN, piSp_mass2, QKN_MAX);
  line->SetLineColor(1);
  line->SetLineStyle(2);
  line->Draw();
  t10->Print("tmp2.pdf");

  his = (TH1F*)Qkn_IMnppipi_acc->ProjectionX();
  ...
  TFile *out = new TFile("outq.root", "recreate");
  his = (TH1F*)Qkn_IMnpipi_acc->ProjectionX();
  his->Write();
  Qkn_IMnpipi_Sp->Write();
  Qkn_IMnpipi_Sm->Write();
  Qkn_IMnppipi_Sp->Write();
  Qkn_IMnppipi_Sm->Write();
  out->Close();
