...
set logdir="${logbasedir}${date}_simpLpim"
...
set OUTDIRSUB="${OUTDIR}simpLpim${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 100)   
  ...
  set CARD___="KnuclSetting_pLpim_DoraAir.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_pLpim_0${jobnum}.root"
