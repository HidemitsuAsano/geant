...
set logdir="${logbasedir}${date}_simL1520pi0"
...
set OUTDIRSUB="${OUTDIR}simL1520pi0_ns${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set CARD___="KnuclSetting_L1520pi0.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_L1520pi0_ns_0${jobnum}.root"
