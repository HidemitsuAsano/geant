...
set logdir="${logbasedir}${date}_simnpipiL_ts"
...
set OUTDIRSUB="${OUTDIR}simnpipiL_ts${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set CARD___="KnuclSetting_npipiL_2step_DoraAir.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_npipiL_ts_0${jobnum}.root"
