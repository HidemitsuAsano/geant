...
set logdir="${logbasedir}${date}_simpipS1385m_ns"
...
set OUTDIRSUB="${OUTDIR}simpipS1385m_ns${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set CARD___="KnuclSetting_pipS1385m_ns.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_pipS1385m_ns_0${jobnum}.root"
