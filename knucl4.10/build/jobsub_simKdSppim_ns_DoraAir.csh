...
set logdir="${logbasedir}${date}_simSppim_ns"
...
set OUTDIRSUB="${OUTDIR}simSppim_ns${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set CARD___="KnuclSetting_Sppim_ns_DoraAir.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_Sppim_ns_0${jobnum}.root"
