...
set logdir="${logbasedir}${date}_simK0nn"
...
set OUTDIRSUB="${OUTDIR}simK0nn${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
while ($i < 400)   
  ...
  set CARD___="KnuclSetting_K0nn_DoraAir.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_K0nn_0${jobnum}.root"
