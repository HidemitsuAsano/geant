...
set logdir="${logbasedir}${date}_simpipiL_ns"
...
set OUTDIRSUB="${OUTDIR}simpipiL_ns${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
#  set CARD___="KnuclSetting_npipiL_DoraAir.card"
  set CARD___="KnuclSetting_pipiL_ns.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_pipiL_ns_0${jobnum}.root"
