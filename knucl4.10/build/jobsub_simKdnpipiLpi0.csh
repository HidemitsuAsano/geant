...
set logdir="${logbasedir}${date}_simnpipiLpi0"
...
set OUTDIRSUB="${OUTDIR}simnpipiLpi0${Version}"
if( ! -d $OUTDIRSUB) then 
 mkdir -p $OUTDIRSUB
endif
...
#  set CARD___="KnuclSetting_npipiL_DoraAir.card"
  set CARD___="KnuclSetting_npipiLpi0.card"
  set MAC___="run.mac"
  set jobnum=`printf  "%03d"  $i`

  #set INPFILE=${DATADIR}"run78_0${jobnum}.dat"
  set OUTFILE=${OUTDIRSUB}"/sim_npipiLpi0_0${jobnum}.root"
