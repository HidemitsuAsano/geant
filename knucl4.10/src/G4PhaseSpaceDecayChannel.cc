...
//
//
// $Id: G4PhaseSpaceDecayChannel.cc,v 1.1.1.1 2013/12/25 01:25:10 sakuma Exp $
//
// 
// ------------------------------------------------------------
...
#endif
  G4double parentmass = current_parent_mass; // 20131213 F.Sakuma

  //create parent G4DynamicParticle at rest
  G4ThreeVector dummy;
  G4DynamicParticle * parentparticle = new G4DynamicParticle( G4MT_parent, dummy, 0.0);
  parentparticle->SetMass(parentmass); // 20131213 F.Sakuma
...
G4DecayProducts *G4PhaseSpaceDecayChannel::TwoBodyDecayIt()
{
  ...
  G4DynamicParticle * parentparticle = new G4DynamicParticle( G4MT_parent, dummy, 0.0);
  parentparticle->SetMass(parentmass); // 20131213 F.Sakuma
  //std::cerr<<"G4PhaseSpaceDecayChannel::TwoBodyDecayIt | (true) "<<parentmass<<std::endl; // 20131213 F.Sakuma
  //std::cerr<<"G4PhaseSpaceDecayChannel::TwoBodyDecayIt | "<<parentparticle->GetMass()<<std::endl; // 20131213 F.Sakuma
  //create G4Decayproducts
  G4DecayProducts *products = new G4DecayProducts(*parentparticle);
  delete parentparticle;
